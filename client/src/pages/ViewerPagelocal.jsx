...
export default function ViewerPage() {
  ...
  return (
    ...
    >
      <h2 class = "headerforview" style={{ marginTop: 0 }}>Annotation Tool</h2>
      ...
      {meta && (
        <>
          ...
          >
            ...
            <div class = "UtilityButtons" style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
              <button class = "annotateButton"
                className={mode === "annotate" ? "btn-active" : "annotateButton"}
                onClick={() => setMode(mode === "annotate" ? "view" : "annotate")}
              >
                {mode === "annotate" ? "Cancel" : "Add Annotation"}
              </button>
              <button className="btn" class="submitButton" onClick={handleSubmit}>
                Submit
              </button>
            </div>
          </div>
